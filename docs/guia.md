...
[![Capa do Guia](./mri-crt.png)](./mri-crt.png)
...
Perícias definem o que uma pessoa é capaz de fazer **bem**.  
...
**Ressonância** representa a **contaminação espiritual** — o quanto alguém foi sintonizado ou corrompido por forças espectrais.  
É medida como uma **porcentagem (0%–100%)**.  
Quanto maior a Ressonância, menos humano o personagem se torna.

> *“Quanto mais você vê os mortos, menos os vivos o veem.”*

### Mecânicas {#mecanicas-ressonancia}

A Ressonância muda conforme a exposição ao sobrenatural e o uso de poderes espectrais.

Sempre que um personagem entra em contato com energia sobrenatural:

`Teste de Vontade (CD conforme a intensidade do evento)`

`Em caso de Falha → +1d6% Ressonância`  
`Em caso de Sucesso → +1d4% Ressonância`

### Limiares de Ressonância {#limites-ressonancia}

| Faixa | Estágio | Efeitos |
|--------|----------|----------|
| **0–20%** | Dormente | Humano. Sem efeitos; calafrios sutis, interferência leve em eletrônicos. |
| **21–40%** | Desperto | Percebe presenças; eletrônicos piscam, sussurros tênues. |
| **41–60%** | Fraturado | Meio-humano. Aura fria, reflexos distorcidos, visível para fantasmas. |
| **61–80%** | Vinculado | Assombrações o seguem. Desconexão física e emocional. |
| **81–99%** | Esmaecido | Manifesta poderes fantasmagóricos incontroláveis. Perda de empatia. |
| **100%** | Perdido | Torna-se uma aparição. O personagem é removido do jogo. |

### Aumentar e Reduzir Ressonância {#aumentar-e-diminuir-ressonancia}

#### Aumentar {#aumentar-ressonancia}
| Evento | Ganho |
|---------|-------|
| Testemunhar uma assombração | +2–5% |
| Tocar ou falar com um fantasma | +5–10% |
| Fazer um Pacto | +15–20% |
| Usar poderes espectrais | +2–5% por uso |
| Ser possuído ou atacado diretamente | +10–30% |
| Realizar um ritual | +10–20% |

#### Reduzir {#diminuir-ressonancia}
| Método | Redução |
|---------|----------|
| **Rituais de Aterramento** | 3–8% (conexão humana, natureza, silêncio). |
...
- A **Ressonância aumenta** significativamente (+15–25%).  
...
|-----------------|-------------|
| **Base Humana** | Os jogadores são vulneráveis; o realismo prevalece sobre o poder. |
| **Perícias em vez de Classes** | Identidade acima de arquétipo; o crescimento é aprendido. |
